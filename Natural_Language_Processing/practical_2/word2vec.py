...
def skipgram(currentCenterWord, windowSize, outsideWords, word2Ind,
    ...
    for outside_word in outsideWords:
        ...
        loss_, grad_center_vec, grad_outside_vecs = word2vecLossAndGradient(center_word_vec, outside_word_idx, outsideVectors, dataset)
        loss += loss_
        gradCenterVecs[center_word_idx] += grad_center_vec
        gradOutsideVectors += grad_outside_vecs
